		...
		<div id="root_container">
			...
			<div class="catalog">
				<div class="inner">
					...
					<div class="block">
						<div class="product">
							<div class="img"><img src="http://static.wixstatic.com/media/affec6_4f066e43ebb143d68b642ef5bad60677.jpg_srz_p_252_214_75_22_0.50_1.20_0.00_jpg_srz" alt=""></div>
							<div class="noimg">
								<div class="title">Стены/потолок «Стандарт»</div>
								<div class="description">Звукоизоляционная система "Стандарт" — конструкция, толщиной всего 40 мм, сочетающая в себе профессиональные акустические материалы и быструю скорость монтажа. Система "Стандарт" в 3 раза уменьшит слышимость исходящих из-за стены бытовых шумов, разговоров и телевизора.</div>
								<div class="info">
									<div class="depth">40мм</div>
									<div class="noise">9дБ</div>
									<div class="price">1000 р/м<sup>2</sup></div>
								</div>
							</div>
						</div>
						<div class="details">
							<div class="item">
								<div class="image"><img src="i/catalog/profile.jpg" alt=""></div>
								<div class="name">Профиль 47x17</div>
							</div>
							<div class="item">
								<div class="image"><img src="i/catalog/butil-cauchuc.jpg" alt=""></div>
								<div class="name">Бутил-каучуковая лента</div>
							</div>
							<div class="item">
								<div class="image"><img src="i/catalog/podves.jpg" alt=""></div>
								<div class="name">Подвес виброизо-лирующий</div>
							</div>
							<div class="item">
								<div class="image"><img src="i/catalog/shelterecostroy.JPG" alt=""></div>
								<div class="name">ШелтерЭко Строй</div>
							</div>
							<div class="item">
								<div class="image"><img src="i/catalog/gvl.jpg" alt=""></div>
								<div class="name">Гипсоволо-книстый лист Knauf</div>
							</div>
							<div class="item">
								<div class="image"><img src="i/catalog/acoustic_germ.jpg" alt=""></div>
								<div class="name">Акустический герметик</div>
							</div>
						</div>
					</div>
					<div class="block">
						<div class="product">
							<div class="img"><img src="http://static.wixstatic.com/media/affec6_4f066e43ebb143d68b642ef5bad60677.jpg_srz_p_252_214_75_22_0.50_1.20_0.00_jpg_srz" alt=""></div>
							<div class="noimg">
								<div class="title">Стены/потолок «Премиум»</div>
								<div class="description">Звукоизоляционная система «Премиум» разработана на базе плит «ЭкоЗвукоИзол», которые обладают наибольшей эффективностью по звукоизоляции из материалов представленных на рынке. Если ваши соседи любят покричать, у них звонко плачет ребёнок, или телевизор работает на слишком большой громкости — выбирайте систему «Премиум», она хорошо изолирует шумы на всех частотах, а для звука высоких и средних частот эта конструкция становится практически непреодолимой преградой.</div>
								<div class="info">
									<div class="depth">50мм</div>
									<div class="noise">15дБ</div>
									<div class="price">2200 р/м<sup>2</sup></div>
								</div>
							</div>
						</div>
						<div class="details">
							...
							<div class="item">
								<div class="image"><img src="i/catalog/ecozvukoezol.jpg" alt=""></div>
								<div class="name">ЭкоЗвуко Изол</div>
							</div>
							<div class="item">
								<div class="image"><img src="i/catalog/gvl.jpg" alt=""></div>
								<div class="name">Гипсоволо-книстый лист Knauf</div>
					...
					<div class="block">
						<div class="product">
							<div class="img"><img src="http://static.wixstatic.com/media/affec6_4f066e43ebb143d68b642ef5bad60677.jpg_srz_p_252_214_75_22_0.50_1.20_0.00_jpg_srz" alt=""></div>
							<div class="noimg">
								<div class="title">Пол «Стандарт»</div>
								<div class="description">BasisFloor - материал, обладающий звуко-вибро-гидроизоляционными свойствами в конструкциях "плавающий пол". Представляет собой рулонный, четырехслойный материал: пенополиэтилен, массивная минеральная масса, клеевой слой и нетканный материал. Улучшает звуко и виброизоляцию пола, и кроме того, отвечает требованиям по гидроизоляции пола. Материал эластичен (при температуре до -20Со), стоек к плесени и гниению, безопасен для человека и долговечен.</div>
								<div class="info">
									<div class="price">340 р/м<sup>2</sup></div>
								</div>
							</div>
						</div>
						<div class="details">
							<div class="item">
								<div class="image"><img src="i/catalog/BasicFloor.jpg" alt=""></div>
								<div class="name">BasisFloor</div>
							</div>
						</div>
					</div>
					<div class="block">
						<div class="product">
							<div class="img"><img src="http://static.wixstatic.com/media/affec6_4f066e43ebb143d68b642ef5bad60677.jpg_srz_p_252_214_75_22_0.50_1.20_0.00_jpg_srz" alt=""></div>
							<div class="noimg">
								<div class="title">Пол «Премиум»</div>
								<div class="description">Система пол «Премиум» это комбинация звукоизоляционных плит «ЭкоЗвукоИзол» и материала BasisFloor, которая при минимальной толщине эффективно борется с шумом проникающим через перекрытия в современных многоквартирных домах.</div>
								<div class="info">
									<div class="depth">19мм</div>
									<div class="noise">11дб</div>
									<div class="price">1200 р/м<sup>2</sup></div>
								</div>
							</div>
						</div>
						<div class="details">
